...
from day_to_day.models import (
    Child, Family_link, DailyFact, Sleep,
    Meal, FeedingBottle, Activity, MedicalEvent, Message,
)
...
class Child_test(TestCase):
    ...
    def test_str(self):
        self.assertEquals(str(self.child), self.child.first_name+" "+self.child.last_name)
    ...
    def test_birth_date_label(self):
        ...
        self.assertEquals(field_label, "Date de Naissance")
        
    def test_vaccine_next_due_date_label(self):
        field_label = self.child._meta.get_field("vaccine_next_due_date").verbose_name
        self.assertEquals(field_label, "Date de Prochaine Vaccination")
    ...
    def test_relative_label(self):
        ...
        self.assertEquals(field_label, "Liens Familiaux")
...
class Family_link_test(TestCase):
    ...
    def test_str(self):
        self.assertEquals(str(self.family_link), self.family_link.link_type)

    def test_child_name_label(self):
        field_label = self.family_link._meta.get_field("child").verbose_name
        self.assertEquals(field_label, "Enfant")
        
    def test_relative_label(self):
        field_label = self.family_link._meta.get_field("relative").verbose_name
        self.assertEquals(field_label, "Membre Familial")
        
    def test_link_type_label(self):
        field_label = self.family_link._meta.get_field("link_type").verbose_name
        self.assertEquals(field_label, "Lien Familial")
        
    def test_retrieval_auth_label(self):
        field_label = self.family_link._meta.get_field("retrieval_auth").verbose_name
        self.assertEquals(field_label, "Autorisation de Prise en Charge")

    def test_emergency_contact_person_label(self):
        field_label = self.family_link._meta.get_field("emergency_contact_person").verbose_name
        self.assertEquals(field_label, "Contact en cas d'urgence")
...
class DailyFact_test(TestCase):
    ...
    def test_str(self):
        eur_date = "{0}-{1}-{2}".format(self.daily_fact.time_stamp.day, self.daily_fact.time_stamp.month, self.daily_fact.time_stamp.year)
        self.assertEquals(str(self.daily_fact), eur_date
    ...
    def test_employee_label(self):
        ...
        self.assertEquals(field_label, "Employé")
        
    def test_time_stamp_type_label(self):
        field_label = self.daily_fact._meta.get_field("time_stamp").verbose_name
        self.assertEquals(field_label, "Horodatage")
        
    def test_comment_auth_label(self):
        field_label = self.daily_fact._meta.get_field("comment").verbose_name
        self.assertEquals(field_label, "Commentaire général")
...
class Meal_test(TestCase):
    ...
    def test_starter_qtty_gr_label(self):
        ...
        self.assertEquals(field_label, "Quantité Entrée mangée en gr")
        
    def test_main_course_qtty_gr_label(self):
        field_label = self.meal._meta.get_field("main_course_qtty_gr").verbose_name
        self.assertEquals(field_label, "Quantité Plat de résistance mangée en gr")

    def test_desert_qtty_gr_qtty_gr_label(self):
        field_label = self.meal._meta.get_field("desert_qtty_gr").verbose_name
        self.assertEquals(field_label, "Quantité Déssert mangée en gr")
...
class FeedingBottle_test(TestCase):
    ...
    def test_str(self):
        self.assertEquals(str(self.feeding_bottle), str(self.feeding_bottle.drank_qtty_ml)+"ml.")
    
    def test_prepared_qtty_ml_qtty_gr_label(self):
        field_label = self.feeding_bottle._meta.get_field("prepared_qtty_ml").verbose_name
        self.assertEquals(field_label, "Quantité Préparée ml")
        
    def test_drank_qtty_ml_label(self):
        field_label = self.feeding_bottle._meta.get_field("drank_qtty_ml").verbose_name
        self.assertEquals(field_label, "Quantité Bue ml")

    def test_daily_fact_qtty_gr_label(self):
        field_label = self.feeding_bottle._meta.get_field("daily_fact").verbose_name
        self.assertEquals(field_label, "Transmission")
...
class Activity_test(TestCase):
    ...
    def test_str(self):
        self.assertEquals(str(self.activity), self.activity.period+" : "+"Motricité Fine"+".")
    
    def test_activity_type_label(self):
        field_label = self.activity._meta.get_field("activity_type").verbose_name
        self.assertEquals(field_label, "Type d'Activité")
        
    def test_period_label(self):
        field_label = self.activity._meta.get_field("period").verbose_name
        self.assertEquals(field_label, "Période")
...
class MedicalEvent_test(TestCase):
    ...
    def test_description_label(self):
        field_label = self.medical_event._meta.get_field("description").verbose_name
        self.assertEquals(field_label, "Description")
        
    def test_body_temp_deg_C_label(self):
        field_label = self.medical_event._meta.get_field("body_temp_deg_C").verbose_name
        self.assertEquals(field_label, "Température en °C")

    def test_given_paracetamol_qtty_mg_label(self):
        field_label = self.medical_event._meta.get_field("given_paracetamol_qtty_mg").verbose_name
        self.assertEquals(field_label, "Paracétamol donné en mg")
        
    def test_paracetamol_given_time_label(self):
        field_label = self.medical_event._meta.get_field("paracetamol_given_time").verbose_name
        self.assertEquals(field_label, "Heure d'administration")

    def test_daily_fact_label(self):
        field_label = self.medical_event._meta.get_field("daily_fact").verbose_name
        self.assertEquals(field_label, "Transmission")
...
class Message_test(TestCase):
    ...
    def test_str(self):
        self.assertEquals(str(self.message), self.message.title)
    ...
    def test_content_label(self):
        ...
        self.assertEquals(field_label, "Contenu")

    def test_cc_facility_label(self):
        field_label = self.message._meta.get_field("cc_facility").verbose_name
        self.assertEquals(field_label, "Structure")
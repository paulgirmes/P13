"""
unit tests for frontpage models
"""
...
class Child_care_facility_test(TestCase):
    ...
    def test_name_label(self):
        ...
        self.assertEqual(field_label, "Nom de la structure")

    def test_max_child_number_label(self):
        field_label = self.cc_facility._meta.get_field(
            "max_child_number"
        ).verbose_name
        self.assertEqual(field_label, "Places maximum")

    def test_type_of_facility_label(self):
        field_label = self.cc_facility._meta.get_field(
            "type_of_facility"
        ).verbose_name
        self.assertEqual(field_label, "Type de structure")

    def test_status_label(self):
        field_label = self.cc_facility._meta.get_field("status").verbose_name
        self.assertEqual(field_label, "Statut")
    ...
    def test_phone_label(self):
        ...
        self.assertEqual(field_label, "Téléphone")

    def test_email_label(self):
        field_label = self.cc_facility._meta.get_field("email").verbose_name
        self.assertEqual(field_label, "Adresse Email")
...
class New_test(TestCase):
    ...
    def test_str(self):
        self.assertEqual(str(self.new), self.new.title)
    ...
    def test_content_label(self):
        ...
        self.assertEqual(field_label, "Contenu texte")
